...
<p><img src="logo2.png" alt="Animal care" style="float:right;width:220px;height:80px;"></p>
    ...
    <tr><th border="0" colspan="8"><font size="5">Admin Information</font></th></tr>    
</tr>
...
error_reporting(0);
$query = "select a_mail, name from admin_info";
...
if($total!=0){
    ...
    while($result=mysqli_fetch_assoc($data)){
        ...
        <td>".$result['a_mail']."</td>
        <td>".$result['name']."</td>
        <td><a href = 'admin_dlt.php?rn=$result[a_mail]'>Delete</a></td>
