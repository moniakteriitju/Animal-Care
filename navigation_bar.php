...
<div class="navbar">
  ...
  <div><a class="icon" href="home.php?em=<?php echo $em ?>"><i class="fa fa-fw fa-home " ></i> Home</a> </div>
  <div><a href="index.html"><i class="fa fa-fw fa-sign-out " ></i> Log Out</a></div>
  <div><a href="user_query.php"><i class="fa fa-fw fa-search " ></i> Search</a></div> 
   ...
   <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="doctor.php">Doctor_profile</a>
